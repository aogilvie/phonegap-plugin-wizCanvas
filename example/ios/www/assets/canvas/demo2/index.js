...
function init() {
	...
	loader.load( "assets/canvas/demo2/obj/leeperrysmith/LeePerrySmith.js", function( geometry ) { createScene( geometry, 100 ) } );
...
function createScene( geometry, scale ) {
	...
	var mapHeight = THREE.ImageUtils.loadTexture( "assets/canvas/demo2/obj/leeperrysmith/Infinite-Level_02_Disp_NoSmoothUV-4096.jpg" );
	...
	var mapSpecular = THREE.ImageUtils.loadTexture( "assets/canvas/demo2/obj/leeperrysmith/Map-SPEC.jpg" );
	...
	var mapColor = THREE.ImageUtils.loadTexture( "assets/canvas/demo2/obj/leeperrysmith/Map-COL.jpg" );
...
function onDocumentTouchMove( ev ) {
	...
	mouseX = ( ev.touches[0].pageX - windowHalfX ) * 1;
	mouseY = ( ev.touches[0].pageY - windowHalfY ) * 1;
