_addTest(function(canvas, ctx) {
    ...
    function draw () {
        ...
        ctx.drawImage(greenImage, 1, 1, 1, 1, 0, 0, 100, 50);
        ctx.drawImage(redImage, 0, 0, 100, 50, -50, 0, 50, 50);
        ctx.drawImage(redImage, 0, 0, 100, 50, 100, 0, 50, 50);
        ctx.drawImage(redImage, 0, 0, 100, 50, 0, -25, 100, 25);
        ctx.drawImage(redImage, 0, 0, 100, 50, 0, 50, 100, 25);
